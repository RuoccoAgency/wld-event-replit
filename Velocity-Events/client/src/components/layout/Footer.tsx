    ...
    <footer className="bg-secondary border-t border-border/20 py-20">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-4 text-[10px] leading-relaxed text-muted-foreground uppercase tracking-widest font-light">
                  <li className="flex items-start gap-2">
                    <MapPin className="w-3 h-3 text-primary shrink-0" />
                    <span>Bolzano / Qualiano<br />Napoli / Quarto</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-4 text-[10px] leading-relaxed text-muted-foreground uppercase tracking-widest font-light">
                  <li className="flex items-start gap-2">
                    <MapPin className="w-3 h-3 text-primary shrink-0" />
                    <span>Barcelona / Adeje<br />Madrid</span>
                  </li>
                </ul>
          ...
          {/* Column 3: Esplora (Now Aligned Top Row) */}
          <div className="md:col-span-1">
